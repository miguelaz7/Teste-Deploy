  ...
  return (
    <div className="od-card">
      ...
      <div className="od-card-body">
        {mensagem && (
          <div style={{ marginBottom: '1rem', padding: '0.75rem', background: '#f0fdf4', borderRadius: 8, color: '#166534', fontSize: '0.875rem', border: '1px solid #bbf7d0' }}>
            {mensagem}
          </div>
        )}
        {msgErro && (
          <div style={{ marginBottom: '1rem', padding: '0.75rem', background: '#fef2f2', borderRadius: 8, color: '#991b1b', fontSize: '0.875rem', border: '1px solid #fecaca' }}>
            {msgErro}
          </div>
        )}
        {loading ? (
