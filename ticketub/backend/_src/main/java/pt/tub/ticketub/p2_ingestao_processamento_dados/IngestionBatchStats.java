...
public class IngestionBatchStats {
    ...
    public IngestionBatchStats() {}

    public IngestionBatchStats(String batchId, OffsetDateTime timestampCiclo,
    ...
    public boolean isAlertaQualidade()       { return alertaQualidade; }
}
