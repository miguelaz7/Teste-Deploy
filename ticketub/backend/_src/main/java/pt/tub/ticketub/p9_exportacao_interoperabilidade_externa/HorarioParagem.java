...
public class HorarioParagem {
    ...
    private Paragem stop;

    @Column(name = "stop_sequence")
    private Integer stopSequence;

    public HorarioParagem() {
    }

    public HorarioParagem(String tripId, String arrivalTime, String departureTime, String stopId, Integer stopSequence) {
        this.tripId = tripId;
